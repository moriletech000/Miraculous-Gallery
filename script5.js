...
sr.reveal('.hero5-text', { delay: 200, origin: 'top' });
sr.reveal('.hero5-img', { delay: 450, origin: 'right' });
sr.reveal('.icons5', { delay: 500, origin: 'left' });
sr.reveal('.scroll-down5', { delay: 500, origin: 'bottom' });

// Video popup
const watchBtn = document.querySelector('.ctaa5');
const videoOverlay = document.querySelector('#video-overlay');
const videoClose = document.querySelector('#video-close');
const videoFrame = document.querySelector('#video-frame');
const videoSrc = 'pollen.mp4';
