...
sr.reveal('.hero3-text', { delay: 200, origin: 'top' });
sr.reveal('.hero3-img', { delay: 450, origin: 'right' });
sr.reveal('.icons3', { delay: 500, origin: 'left' });
sr.reveal('.scroll-down3', { delay: 500, origin: 'bottom' });

// Video popup
const watchBtn = document.querySelector('.ctaa3');
const videoOverlay = document.querySelector('#video-overlay');
const videoClose = document.querySelector('#video-close');
const videoFrame = document.querySelector('#video-frame');
const videoSrc = 'Nooroo.mp4';
