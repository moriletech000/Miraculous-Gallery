...
sr.reveal('.hero6-text', { delay: 200, origin: 'top' });
sr.reveal('.hero6-img', { delay: 450, origin: 'right' });
sr.reveal('.icons6', { delay: 500, origin: 'left' });
sr.reveal('.scroll-down6', { delay: 500, origin: 'bottom' });

// Video popup
const watchBtn = document.querySelector('.ctaa6');
const videoOverlay = document.querySelector('#video-overlay');
const videoClose = document.querySelector('#video-close');
const videoFrame = document.querySelector('#video-frame');
const videoSrc = 'trixx.mp4';
